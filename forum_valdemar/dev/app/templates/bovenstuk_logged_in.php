        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="mainNavbar">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="profile.php" <?= isActive('profile') ? 'class="active"' : "" ?>><img class="profielfoto" src="img/pf2.jpg" alt="photo"> Profiel</a></li><!--<span class="fa fa-user"></span>-->
                    <li><a href="login.php" <?= isActive('login') ? 'class="active"' : "" ?>>Log Out <span class="fa fa-lock"></span></a></li>
                </ul>
            </div>
        </div>
    </nav>
